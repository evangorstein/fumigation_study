...
ggsave("plot_graph/never_glasso_fungi.png", plot.never.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_glasso_largest_cluster_fungi.png", subplot.never.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_glasso_fungi.png", plot.recent.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_glasso_largest_cluster_fungi.png", subplot.recent.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_glasso_fungi.png", plot.past.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_glasso_largest_cluster_fungi.png", subplot.past.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_diss_fungi.png", plot.never.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_diss_largest_cluster_fungi.png", subplot.never.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_diss_fungi.png", plot.recent.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_diss_largest_cluster_fungi.png", subplot.recent.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_diss_fungi.png", plot.past.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_diss_largest_cluster_fungi.png", subplot.past.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_corr_fungi.png", plot.never.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_corr_largest_cluster_fungi.png", subplot.never.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_corr_fungi.png", plot.recent.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_corr_largest_cluster_fungi.png", subplot.recent.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_corr_fungi.png", plot.past.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_corr_largest_cluster_fungi.png", subplot.past.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_combined_fungi.png", never_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/never_subgraph_fungi.png", never_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_combined_fungi.png", recent_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/recent_subgraph_fungi.png", recent_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_combined_fungi.png", past_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/past_subgraph_fungi.png", past_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/dg_combined_bp_fungi.pdf", dg_combined_bp)
```
...
ggsave("plot_graph/dg_combined_betweenness_bp_fungi.pdf", dg_combined_betweenness_bp)
```
...
ggsave("plot_graph/dg_glasso_bp_fungi.pdf", dg_glasso_bp)
```
...
ggsave("plot_graph/dg_glasso_betweenness_bp_fungi.pdf", dg_glasso_betweenness_bp)
```
...
ggsave("plot_graph/dg_diss_bp_fungi.pdf", dg_diss_bp)
```
...
ggsave("plot_graph/dg_diss_betweenness_bp_fungi.pdf", dg_diss_betweenness_bp)
```
...
ggsave("plot_graph/dg_corr_bp_fungi.pdf", dg_corr_bp)
```
...
ggsave("plot_graph/dg_corr_betweenness_bp_fungi.pdf", dg_corr_betweenness_bp)
```
...
```{r}
png("plot_graph/carlasso_plot_fungi_both.png")
plot(response.horse)
dev.off()
```
...
```{r}
png("plot_graph/carlasso_plot_fungi_single.png")
...
```{r}
png("plot_graph/carlasso_plot_fungi_both_10.png")
...
```{r}
png("plot_graph/carlasso_plot_fungi_single_10.png")
