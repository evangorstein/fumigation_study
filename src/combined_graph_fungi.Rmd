...
cairo_pdf("plot_high_quality/carlasso_plot_fungi_both.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
plot(response.horse)
dev.off()
```
...
options(repr.plot.res = 1200)
par(mar = c(5, 4, 4, 2) + 0.1)
cairo_pdf("plot_high_quality/carlasso_plot_fungi_single.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
...
options(repr.plot.res = 1200)
par(mar = c(5, 4, 4, 2) + 0.1)
cairo_pdf("plot_high_quality/carlasso_plot_fungi_both_10.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
...
options(repr.plot.res = 1200)
par(mar = c(5, 4, 4, 2) + 0.1)
cairo_pdf("plot_high_quality/carlasso_plot_fungi_single_10.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
