...
never_subgraph_plot = ggraph(subgraph.never, layout = "fr") +
  ...
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.never) > 15, degree(subgraph.never), 15)), family = "serif", repel = TRUE, show.legend = FALSE) +
  theme_graph() +
  ggtitle("Edges in All Three Networks for Never Fumigated")

never_subgraph_plot

ggsave("plot_graph/never_subgraph_fungi.png", never_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
recent_subgraph_plot = ggraph(subgraph.recent, layout = "fr") +
  ...
  scale_edge_color_discrete("Edge\nWeight", labels = c("3" = "In All Three Networks")) +
  geom_node_point(aes(fill = "#E99093"), shape = 21, size = 3, show.legend = FALSE) +
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.recent) > 10, degree(subgraph.recent), 10)), family = "serif", repel = TRUE, show.legend = FALSE) +
  theme_graph() +
  ggtitle("Edges Present in All Three Networks for Recent Fumigated Samples")

recent_subgraph_plot

ggsave("plot_graph/recent_subgraph_fungi.png", recent_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
past_subgraph_plot = ggraph(subgraph.past, layout = "fr") +
  ...
  scale_edge_color_discrete("Edge\nWeight", labels = c("3" = "In All Three Networks")) +
  geom_node_point(aes(fill = "#E99093"), shape = 21, size = 3, show.legend = FALSE) +
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.past) > 12, degree(subgraph.past), 12)), family = "serif", repel = TRUE, show.legend =  FALSE) +
  theme_graph() +
  ggtitle("Edges Present in All Three Networks for Past Fumigated Samples")

past_subgraph_plot

ggsave("plot_graph/past_subgraph_fungi.png", past_subgraph_plot, width = 12, height = 10, dpi = 300)
```
