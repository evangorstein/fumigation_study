...
ggsave("plot_high_quality/carlasso_plot_fungi_both.pdf", fungi_both_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/carlasso_plot_fungi_single.pdf", fungi_single_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/carlasso_plot_fungi_both_10.pdf", fungi_both_10_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/carlasso_plot_fungi_single_10.pdf", fungi_single_10_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
