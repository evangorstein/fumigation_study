...
```{r}
response = CARlasso(formula_both, data = day0_df, link = "logit", adaptive = TRUE, n_iter = 1000)
```
...
```{r}
response2 = CARlasso(formula_both, data = day10_df, link = "logit", adaptive = TRUE, n_iter = 1000)
```
...
```{r}
response3 = CARlasso(formula_both, data = day282_df, link = "logit", adaptive = TRUE, n_iter = 1000)
```
