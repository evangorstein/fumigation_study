...
dis_net = function(mat, cutoff){
    # TODO: considering normalizing the data?
    # Normalize the data
    mat = t(mat)
    #print(library_size)
    fam.ls = t( t(mat) / colSums(mat))
    
    normal_mat = t(fam.ls)
    diss.mat = as.matrix(vegdist(t(normal_mat)), method = "bray")
    diss.adj = ifelse(diss.mat <= cutoff, 1, 0)
    # change all NA to 1
    diss.adj[is.na(diss.adj)] = 1
...
plot_network = function(net, title, filter){
    ...
    geom_node_text(aes(filter = size > filter, label = name, size = ifelse(degree(net) > 15, degree(net), 15)), family = "serif", repel = TRUE, show.legend = FALSE) +
...
# net: net object, title: title of plot, filter: filter out nodes with degree less than filter
plot_circular_network = function(net, title, filter){
    network = ggraph(net, layout = "circle") +
    geom_edge_link0(color = "grey66") +
    geom_node_point(aes(fill = clu, size = size), shape = 21) +
    geom_node_text(aes(filter = size > filter, label = name, size = ifelse(degree(net) > 15, degree(net), 15)), family = "serif", repel = TRUE, show.legend = FALSE) +
    scale_edge_width(range = c(0.2, 3)) +
...
ggsave("plot_high_quality/never_glasso.pdf", plot.never.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_glasso_largest_cluster.pdf", subplot.never.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_glasso.pdf", plot.recent.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_glasso_largest_cluster.pdf", subplot.recent.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_glasso.pdf", plot.past.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_glasso_largest_cluster.pdf", subplot.past.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_diss.pdf", plot.never.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)  
```
...
ggsave("plot_high_quality/never_diss_largest_cluster.pdf", subplot.never.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_diss.pdf", plot.recent.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_diss_largest_cluster.pdf", subplot.recent.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_diss.pdf", plot.past.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_diss_largest_cluster.pdf", subplot.past.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_corr.pdf", plot.never.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_corr_largest_cluster.pdf", subplot.never.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_corr.pdf", plot.recent.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_corr_largest_cluster.pdf", subplot.recent.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_corr.pdf", plot.past.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_corr_largest_cluster.pdf", subplot.past.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
never_combined_plot =ggraph(combined_graph.never, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = TRUE) +
  scale_edge_color_manual("Edge\nWeight", 
                          values = c("1" = "#93D150", "2" = "#FFD966", "3" = "#7BC8F6"), 
                          labels = c("1" = "Only in One Network", "2" = "In Two Networks", "3" = "In All Three Networks")) +
...
ggsave("plot_high_quality/never_combined.pdf", never_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# plot the subgraph
never_subgraph_plot = ggraph(subgraph.never, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = FALSE) +
  ...
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.never) > 15, degree(subgraph.never), 15)), size = 6,family = "serif", repel = TRUE, show.legend = FALSE) +
  theme_graph() +
  ggtitle("Edges in All Three Networks for Never Fumigated")

never_subgraph_plot

ggsave("plot_high_quality/never_subgraph.pdf", never_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
recent_combined_plot = ggraph(combined_graph.recent, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = TRUE) +
  scale_edge_color_manual("Edge\nWeight", 
                          values = c("1" = "#93D150", "2" = "#FFD966", "3" = "#7BC8F6"), 
                          labels = c("1" = "Only in One Network", "2" = "In Two Networks", "3" = "In All Three Networks")) +
...
recent_combined_plot

ggsave("plot_high_quality/recent_combined.pdf", recent_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# plot the subgraph
recent_subgraph_plot = ggraph(subgraph.recent, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = FALSE) +
  scale_edge_color_discrete("Edge\nWeight", labels = c("3" = "In All Three Networks")) +
  geom_node_point(aes(fill = "#E99093"), shape = 21, size = 3, show.legend = FALSE) +
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.recent) > 10, degree(subgraph.recent), 10)), size = 6,family = "serif", repel = TRUE, show.legend = FALSE) +
  theme_graph() +
  ggtitle("Edges Present in All Three Networks for Recent Fumigated Samples")

recent_subgraph_plot

ggsave("plot_high_quality/recent_subgraph.pdf", recent_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
past_combined_plot = ggraph(combined_graph.past, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = TRUE) +
  scale_edge_color_manual("Edge\nWeight", 
                          values = c("1" = "#93D150", "2" = "#FFD966", "3" = "#7BC8F6"), 
                          labels = c("1" = "Only in One Network", "2" = "In Two Networks", "3" = "In All Three Networks")) +
...
ggsave("plot_high_quality/past_combined.pdf", past_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# plot the subgraph
past_subgraph_plot = ggraph(subgraph.past, layout = "fr") +
  geom_edge_link0(aes(edge_color = as.factor(weight)), show.legend = FALSE) +
  scale_edge_color_discrete("Edge\nWeight", labels = c("3" = "In All Three Networks")) +
  geom_node_point(aes(fill = "#E99093"), shape = 21, size = 3, show.legend = FALSE) +
  geom_node_text(aes(filter = size >= 25, label = name, size = ifelse(degree(subgraph.past) > 12, degree(subgraph.past), 12)), size = 6,family = "serif", repel = TRUE, show.legend =  FALSE) +
  theme_graph() +
  ggtitle("Edges Present in All Three Networks for Past Fumigated Samples")

past_subgraph_plot

ggsave("plot_high_quality/past_subgraph.pdf", past_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
overall_df = data.frame(
  fumigation_status = c(rep("never", length(degree.never)), rep("recent", length(degree.recent)), rep("past", length(degree.past))),
  degree = c(degree.never, degree.recent, degree.past)
)

dg_combined_bp = ggplot(overall_df, aes(x = fumigation_status, y = degree)) +
  geom_boxplot() +
  theme_minimal() +
...
ggsave("plot_high_quality/dg_combined_bp.pdf", dg_combined_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

```{r}
overall_betweenness_df = data.frame(
  fumigation_status = c(rep("never", length(betweenness.never)), rep("recent", length(betweenness.recent)), rep("past", length(betweenness.past))),
  betweenness = c(betweenness.never, betweenness.recent, betweenness.past)
)

bt_combined_bp = ggplot(overall_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
ggsave("plot_high_quality/bt_combined_bp.pdf", bt_combined_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

Glasso
```{r}
glasso_degree_df = data.frame(
  fumigation_status = c(rep("never", length(glasso.degree.never)), rep("recent", length(glasso.degree.recent)), rep("past", length(glasso.degree.past))),
  degree = c(glasso.degree.never, glasso.degree.recent, glasso.degree.past)
)

dg_glasso_bp = ggplot(glasso_degree_df, aes(x = fumigation_status, y = degree)) +
  geom_boxplot() +
  theme_minimal() +
...
ggsave("plot_high_quality/dg_glasso_bp.pdf", dg_glasso_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```


```{r}
glasso_betweenness_df = data.frame(
  fumigation_status = c(rep("never", length(glasso.betweenness.never)), rep("recent", length(glasso.betweenness.recent)), rep("past", length(glasso.betweenness.past))),
  betweenness = c(glasso.betweenness.never, glasso.betweenness.recent, glasso.betweenness.past)
)

bt_glasso_bp = ggplot(glasso_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
ggsave("plot_high_quality/bt_glasso_bp.pdf", bt_glasso_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

Dissimilarity
```{r}
diss_degree_df = data.frame(
  fumigation_status = c(rep("never", length(diss.degree.never)), rep("recent", length(diss.degree.recent)), rep("past", length(diss.degree.past))),
  degree = c(diss.degree.never, diss.degree.recent, diss.degree.past)
)

dg_diss_bp = ggplot(diss_degree_df, aes(x = fumigation_status, y = degree)) +
  geom_boxplot() +
  theme_minimal() +
  labs(x = "Fumigation Status", y = "Degree Distribution", title = "Dissimilarity Network") +
  theme(
    plot.title = element_text(size = 25, hjust = 0.5),  # Increase the size of the plot title
    axis.title.x = element_text(size = 20, margin = margin(t = 15)),  # Increase the size of the x-axis title
    axis.title.y = element_text(size = 30, margin = margin(r = 15)),  # Increase the size of the y-axis title
...
ggsave("plot_high_quality/dg_diss_bp.pdf", dg_diss_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

```{r}
diss_betweenness_df = data.frame(
  fumigation_status = c(rep("never", length(diss.betweenness.never)), rep("recent", length(diss.betweenness.recent)), rep("past", length(diss.betweenness.past))),
  betweenness = c(diss.betweenness.never, diss.betweenness.recent, diss.betweenness.past)
)

bt_diss_bp = ggplot(diss_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
  labs(x = "Fumigation Status", y = "Betweenness Distribution", title = "Dissimilarity Network") +
  theme(
    plot.title = element_text(size = 25, hjust = 0.5),  # Increase the size of the plot title
    axis.title.x = element_text(size = 20, margin = margin(t = 15)),  # Increase the size of the x-axis title
    axis.title.y = element_text(size = 30, margin = margin(r = 15)),  # Increase the size of the y-axis title
...
ggsave("plot_high_quality/bt_diss_bp.pdf", bt_diss_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

Correlation
```{r}
corr_degree_df = data.frame(
  fumigation_status = c(rep("never", length(corr.degree.never)), rep("recent", length(corr.degree.recent)), rep("past", length(corr.degree.past))),
  degree = c(corr.degree.never, corr.degree.recent, corr.degree.past)
)

dg_corr_bp = ggplot(corr_degree_df, aes(x = fumigation_status, y = degree)) +
  geom_boxplot() +
  theme_minimal() +
  labs(x = "Fumigation Status", y = "Degree Distribution", title = "Correlation Network") +
  theme(
    plot.title = element_text(size = 25, hjust = 0.5),  # Increase the size of the plot title
    axis.title.x = element_text(size = 20, margin = margin(t = 15)),  # Increase the size of the x-axis title
    axis.title.y = element_text(size = 30, margin = margin(r = 15)),  # Increase the size of the y-axis title
...
ggsave("plot_high_quality/dg_corr_bp.pdf", dg_corr_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```


```{r}
corr_betweenness_df = data.frame(
  fumigation_status = c(rep("never", length(corr.betweenness.never)), rep("recent", length(corr.betweenness.recent)), rep("past", length(corr.betweenness.past))),
  betweenness = c(corr.betweenness.never, corr.betweenness.recent, corr.betweenness.past)
)

bt_corr_bp = ggplot(corr_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
  labs(x = "Fumigation Status", y = "Betweenness Distribution", title = "Correlation Network") +
  theme(
    plot.title = element_text(size = 25, hjust = 0.5),  # Increase the size of the plot title
    axis.title.x = element_text(size = 20, margin = margin(t = 15)),  # Increase the size of the x-axis title
    axis.title.y = element_text(size = 30, margin = margin(r = 15)),  # Increase the size of the y-axis title
...
ggsave("plot_high_quality/bt_corr_bp.pdf", bt_corr_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
bact_both_plot = plot(response.horse) + 
  theme(
...
# cairo_pdf("plot_high_quality/carlasso_plot_bact_both.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
# plot(response.horse)
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_both.pdf", bact_both_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# options(repr.plot.res = 1200)
# par(mar = c(5, 4, 4, 2) + 0.1)
bact_single_plot = plot(response2.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.5, 'cm')          
  )
# cairo_pdf("plot_high_quality/carlasso_plot_bact_single.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
# plot(response2.horse)
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_single.pdf", bact_single_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# options(repr.plot.res = 1200)
# par(mar = c(5, 4, 4, 2) + 0.1)
bact_both_10_plot = plot(response10.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.7, 'cm')          
  )
# cairo_pdf("plot_high_quality/carlasso_plot_bact_both_10.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
# plot(response10.horse)
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_both_10.pdf", bact_both_10_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
response10_2 = CARlasso(formula_single10, data = fam_df, link = "logit", adaptive = TRUE)
```
...
# options(repr.plot.res = 1200)
# par(mar = c(5, 4, 4, 2) + 0.1)
bact_single_10_plot = plot(response10_2.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.7, 'cm')          
  )
# cairo_pdf("plot_high_quality/carlasso_plot_bact_single_10.pdf", width = 12, height = 10, bg = "white", fallback_resolution = 1200, onefile = TRUE)
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_single_10.pdf", bact_single_10_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```

## Investigation

```{r}
r2.data = response2.horse$point_est$CAR$C
r210.data = response10_2.horse$point_est$CAR$C
```

Appears CARlasso on a subset of taxa's result is different than the whole set.

```{r}
#never dataframe
never_mat = fam.mat[never_fumigated,]
recent_mat = fam.mat[recent_fumigated,]
past_mat = fam.mat[past_fumigated,]

d1 = sum(never_mat[,"Diplorickettsiaceae"])
d2 = sum(recent_mat[,"Diplorickettsiaceae"])
d3 = sum(past_mat[,"Diplorickettsiaceae"])
```

```{r}
# top 20 df with sum of abundance in never, recent, past
for (name in top_20$names) {
  d1 = sum(never_mat[,name])
  d2 = sum(recent_mat[,name])
  d3 = sum(past_mat[,name])
  print(paste(name, d1, d2, d3))
}
```

The top 20's taxa's abundance is different in never, recent, past. (Sum across all samples of corresponding fumigation status)

Now, we classify the top 20 taxa into 3 groups.
1. Abundance in recent is lower than never, and past is higher than recent but lower than never.
2. Abundance in recent is higher than never, and past is lower than recent but higher than never.
3. Abundance in recent is higher than never, and past is higher.
4. Abundance in recent is lower than never, and past is lower.
...
for (name in top_20$names) {
  d1 = sum(never_mat[,name]) / length(never_fumigated)
  d2 = sum(recent_mat[,name]) / length(recent_fumigated)
  d3 = sum(past_mat[,name]) / length(past_fumigated)
  if ((d2 < d1) && (d3 < d1)) {
    group = 1
  }
  ...
  group_df[group_df$names == name,]$d1 = d1
  group_df[group_df$names == name,]$d2 = d2
  group_df[group_df$names == name,]$d3 = d3
  group_df[group_df$names == name,]$group = group
}
group_df
```


Analysis of Edges identified by all 3 networks

```{r}
# get otu from edges in all 3 networks
otu.never = union(edges_in_all_3_never$V1, edges_in_all_3_never$V2)
otu.recent = union(edges_in_all_3_recent$V1, edges_in_all_3_recent$V2)
otu.past = union(edges_in_all_3_past$V1, edges_in_all_3_past$V2)

overall = union(otu.never, otu.recent)
overall = union(overall, otu.past)
...
```{r}
# function to make a df with otu and their abundance in each fumigation status
otu_df = function(names) {
  new_df = data.frame(
  names = names,
  d1 = NA,
  d2 = NA,
  ...
  for (name in names) {
    ...
    new_df[new_df$names == name,]$d1 = d1
    new_df[new_df$names == name,]$d2 = d2
    new_df[new_df$names == name,]$d3 = d3
    new_df[new_df$names == name,]$group = group
  }
  return(new_df)
}
```
...
```{r}
# make df for otu in all 3 networks
all_3_never_df = otu_df(otu.never)
all_3_recent_df = otu_df(otu.recent)
all_3_past_df = otu_df(otu.past)
