...
# Aggregate based on genuses. Choose to look at genus OTU.
...
ggsave("plot_high_quality/never_glasso_fungi.pdf", plot.never.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_glasso_largest_cluster_fungi.pdf", subplot.never.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_glasso_fungi.pdf", plot.recent.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_glasso_largest_cluster_fungi.pdf", subplot.recent.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_glasso_fungi.pdf", plot.past.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_glasso_largest_cluster_fungi.pdf", subplot.past.glasso, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_diss_fungi.pdf", plot.never.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_diss_largest_cluster_fungi.pdf", subplot.never.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_diss_fungi.pdf", plot.recent.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_diss_largest_cluster_fungi.pdf", subplot.recent.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_diss_fungi.pdf", plot.past.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_diss_largest_cluster_fungi.pdf", subplot.past.diss, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_corr_fungi.pdf", plot.never.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_corr_largest_cluster_fungi.pdf", subplot.never.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_corr_fungi.pdf", plot.recent.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_corr_largest_cluster_fungi.pdf", subplot.recent.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_corr_fungi.pdf", plot.past.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_corr_largest_cluster_fungi.pdf", subplot.past.corr, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_combined_fungi.pdf", never_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/never_subgraph_fungi.pdf", never_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_combined_fungi.pdf", recent_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/recent_subgraph_fungi.pdf", recent_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_combined_fungi.pdf", past_combined_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/past_subgraph_fungi.pdf", past_subgraph_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/dg_combined_bp_fungi.pdf", dg_combined_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
dg_combined_betweenness_bp = ggplot(overall_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
dg_combined_betweenness_bp

ggsave("plot_high_quality/dg_combined_betweenness_bp_fungi.pdf", dg_combined_betweenness_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/dg_glasso_bp_fungi.pdf", dg_glasso_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
dg_glasso_betweenness_bp = ggplot(glasso_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
dg_glasso_betweenness_bp

ggsave("plot_high_quality/dg_glasso_betweenness_bp_fungi.pdf", dg_glasso_betweenness_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/dg_diss_bp_fungi.pdf", dg_diss_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
dg_diss_betweenness_bp = ggplot(diss_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
dg_diss_betweenness_bp

ggsave("plot_high_quality/dg_diss_betweenness_bp_fungi.pdf", dg_diss_betweenness_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
ggsave("plot_high_quality/dg_corr_bp_fungi.pdf", dg_corr_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
dg_corr_betweenness_bp = ggplot(corr_betweenness_df, aes(x = fumigation_status, y = betweenness)) +
  geom_boxplot() +
  theme_minimal() +
...
dg_corr_betweenness_bp

ggsave("plot_high_quality/dg_corr_betweenness_bp_fungi.pdf", dg_corr_betweenness_bp, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
fungi_both_plot = plot(response.horse) + 
  theme(
...
ggsave("plot_high_quality/carlasso_plot_fungi_both.pdf", fungi_both_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
fungi_single_plot = plot(response2.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.7, 'cm')          
...
ggsave("plot_high_quality/carlasso_plot_fungi_single.pdf", fungi_single_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
fungi_both_10_plot = plot(response10.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.7, 'cm')          
...
ggsave("plot_high_quality/carlasso_plot_fungi_both_10.pdf", fungi_both_10_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
fungi_single_10_plot = plot(response10_2.horse) + 
  theme(
    legend.title = element_text(size = 22),    # Legend title size
    legend.text = element_text(size = 20),     # Legend text size
    legend.key.size = unit(1.7, 'cm')          
...
ggsave("plot_high_quality/carlasso_plot_fungi_single_10.pdf", fungi_single_10_plot, width = 15, height = 15, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
```{r}
#never dataframe
never_mat = genus.mat[never_fumigated,]
recent_mat = genus.mat[recent_fumigated,]
past_mat = genus.mat[past_fumigated,]
