...
fam.mat_treat = fam.mat[rownames(fam.mat) %in% samp_ids, ]
fam.mat.filt_treat = fam.mat.filt[rownames(fam.mat.filt) %in% samp_ids, ]
fam.mat.harsh_treat = fam.mat.harsh[rownames(fam.mat.harsh) %in% samp_ids, ]
```
...
```{r}
# calculating the distance matrix, we can specify different method depends on our normalization method
dist_matrix_4 = vegdist(fam.mat_treat, method = "bray")
dist_matrix_5 = vegdist(fam.mat.filt_treat, method = "bray")
dist_matrix_6 = vegdist(fam.mat.harsh_treat, method = "bray")
