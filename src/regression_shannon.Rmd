...
p_fumigation_b <- ggplot(sample_metadata, aes(x=fumigation, y=shannon)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title="Alpha-Diversity (Shannon) by Fumigation Status",
       x="Fumigation Status", y="Alpha-Diversity (Shannon)") +
...
```{r}
# save plot as pdf
ggsave("shannon_fumigation_bacteria.pdf", p_fumigation_b)
```
...
p_treatment_b <- ggplot(sample_metadata_treat, aes(x=Treatment, y=shannon)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title="Alpha-Diversity (Shannon) by Treatment",
       x="Treatment", y="Alpha-Diversity (Shannon)") +
...
```{r}
# save plot as pdf
ggsave("shannon_treatment_bacteria.pdf", p_treatment_b)
```
...
p_fumigation_f <- ggplot(sample_metadata, aes(x=fumigation, y=shannon_fungi)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title="Alpha-Diversity (Shannon) for Fungi by Fumigation Status",
       x="Fumigation Status", y="Alpha-Diversity (Shannon)") +
...
```{r}
# save plot as pdf
ggsave("shannon_fumigation_fungi.pdf", p_fumigation_f)
```
...
p_treatment_f <- ggplot(sample_metadata_treat, aes(x=Treatment, y=shannon_fungi)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title="Alpha-Diversity (Shannon) for Fungi by Treatment",
       x="Treatment", y="Alpha-Diversity (Shannon)") +
...
```{r}
# save plot as pdf
ggsave("shannon_treatment_fungi.pdf", p_treatment_f)
```
