...
ggsave("plot_graph/never_subgraph.png", never_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_subgraph.png", recent_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_subgraph.png", past_subgraph_plot, width = 12, height = 10, dpi = 300)
```
