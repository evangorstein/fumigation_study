...
# plot(response.horse)
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_both.pdf", bact_both_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_single.pdf", bact_single_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_both_10.pdf", bact_both_10_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
...
# dev.off()
ggsave("plot_high_quality/carlasso_plot_bact_single_10.pdf", bact_single_10_plot, width = 12, height = 10, dpi = 600, device = cairo_pdf, bg = "white", limitsize = FALSE)
```
