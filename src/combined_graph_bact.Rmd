...
```{r}
png("plot_graph/dg_combined_bp.png", width = 1200, height = 1000, res = 300)
boxplot(
...
```{r}
betweenness_combined_bp = boxplot(
...
betweenness_combined_bp

ggsave("plot_graph/betweenness_combined_bp.png", betweenness_combined_bp, width = 12, height = 10, dpi = 300)
```

Glasso
```{r}
glasso_degree_bp = boxplot(
...
ggsave("plot_graph/glasso_degree_bp.png", glasso_degree_bp, width = 12, height = 10, dpi = 300)
```
```{r}
glasso_betweenness_bp = boxplot(
...
glasso_betweenness_bp

ggsave("plot_graph/glasso_betweenness_bp.png", glasso_betweenness_bp, width = 12, height = 10, dpi = 300)
```

Dissimilarity
```{r}
diss_degree_bp = boxplot(
...
ggsave("plot_graph/diss_degree_bp.png", diss_degree_bp, width = 12, height = 10, dpi = 300)
```

```{r}
diss_betweenness_bp = boxplot(
...
ggsave("plot_graph/diss_betweenness_bp.png", diss_betweenness_bp, width = 12, height = 10, dpi = 300)
```

Correlation
```{r}
corr_degree_bp = boxplot(
...
ggsave("plot_graph/corr_degree_bp.png", corr_degree_bp, width = 12, height = 10, dpi = 300)
```

```{r}
corr_betweenness_bp = boxplot(
...
ggsave("plot_graph/corr_betweenness_bp.png", corr_betweenness_bp, width = 12, height = 10, dpi = 300)
```
