...
ggsave("plot_graph/never_glasso.png", plot.never.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_glasso_largest_cluster.png", subplot.never.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_glasso.png", plot.recent.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_glasso_largest_cluster.png", subplot.recent.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_glasso.png", plot.past.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_glasso_largest_cluster.png", subplot.past.glasso, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_diss.png", plot.never.diss, width = 12, height = 10, dpi = 300)  
```
...
ggsave("plot_graph/never_diss_largest_cluster.png", subplot.never.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_diss.png", plot.recent.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_diss_largest_cluster.png", subplot.recent.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_diss.png", plot.past.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_diss_largest_cluster.png", subplot.past.diss, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_corr.png", plot.never.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_corr_largest_cluster.png", subplot.never.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_corr.png", plot.recent.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_corr_largest_cluster.png", subplot.recent.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_corr.png", plot.past.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_corr_largest_cluster.png", subplot.past.corr, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/never_combined.png", never_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/never_subgraph.png", never_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/recent_combined.png", recent_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/recent_subgraph.png", recent_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/past_combined.png", past_combined_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_1029/past_subgraph.png", past_subgraph_plot, width = 12, height = 10, dpi = 300)
```
...
ggsave("plot_graph/dg_combined_bp.pdf", dg_combined_bp)
```
...
ggsave("plot_graph/bt_combined_bp.pdf", bt_combined_bp)
```
...
ggsave("plot_graph/dg_glasso_bp.pdf", dg_glasso_bp)
```
...
ggsave("plot_graph/bt_glasso_bp.pdf", bt_glasso_bp)
```
...
ggsave("plot_graph/dg_diss_bp.pdf", dg_diss_bp)
```
...
ggsave("plot_graph/bt_diss_bp.pdf", bt_diss_bp)
```
...
ggsave("plot_graph/dg_corr_bp.pdf", dg_corr_bp)
```
...
ggsave("plot_graph/bt_corr_bp.pdf", bt_corr_bp)
```
...
```{r}
# save plot
png("plot_graph/carlasso_plot_bact_both.png")
plot(response.horse)
dev.off()
```
...
```{r}
png("plot_graph/carlasso_plot_bact_single.png")
...
```{r}
png("plot_graph/carlasso_plot_bact_both_10.png")
...
```{r}
png("plot_graph/carlasso_plot_bact_single_10.png")
