...
```{r}
png("plot_graph/betweenness_combined_bp.png", width = 1200, height = 1000, res = 300)
...
Glasso
```{r}
png("plot_graph/glasso_degree_bp.png", width = 1200, height = 1000, res = 300)
...
```
```{r}
png("plot_graph/glasso_betweenness_bp.png", width = 1200, height = 1000, res = 300)
...
Dissimilarity
```{r}
png("plot_graph/diss_degree_bp.png", width = 1200, height = 1000, res = 300)
...
```{r}
png("plot_graph/diss_betweenness_bp.png", width = 1200, height = 1000, res = 300)
...
Correlation
```{r}
png("plot_graph/corr_degree_bp.png", width = 1200, height = 1000, res = 300)
...
```{r}
png("plot_graph/corr_betweenness_bp.png", width = 1200, height = 1000, res = 300)
