...
plt1 = create_heatmap(phylum.lr,
                      ...
                      ylabel = "All 44 bacterial families"
)
dev.off()
...
plt1.filt = create_heatmap(phylum.lr.filt,
                           ...
                           title = "Log ratio normalized abundances", 
                           xlabel = "Samples 1-240", 
                           ylabel = "27 most abundant bacterial families"
)
dev.off()
...
plt1.harsh = create_heatmap(phylum.lr.harsh,
                            ...
                            title = "Log ratio normalized abundances", 
                            xlabel = "Samples 1-240", 
                            ylabel = "14 most abundant bacterial families"
)
dev.off()
...
all_otus = heatmapdata.phylum.lr$OTU

heatmapdata.phylum.lr = heatmapdata.phylum.lr %>% 
  select(-OTU)

row.names(heatmapdata.phylum.lr) = all_otus
```
